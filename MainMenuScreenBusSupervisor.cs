...
{
    public partial class MainMenuScreenBusSupervisor : Form
    {
        //Create a record
        class Bus
        {
        ...
        public MainMenuScreenBusSupervisor()
        {
            InitializeComponent();
        ...
        //Event that reads the .XML file and also sets the aesthetics of the combobox
        private void MainMenuScreenBusSupervisor_Load(object sender, EventArgs e)
        {
            ReadXMLFile();
        ...
        private void MainMenuScreenBusSupervisorMouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void MainMenuScreenBusSupervisorMouseMove(object sender, MouseEventArgs e)
        {
        ...
        //Event that takes the user to the HelpBusSupervisor screen when the Help button is clicked
        private void btnHelp_Click(object sender, EventArgs e)
        {
            //Define the form
            var Form1 = new HelpScreenBusSupervisor();
